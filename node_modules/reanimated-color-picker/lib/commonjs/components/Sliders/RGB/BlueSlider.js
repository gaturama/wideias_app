...
function BlueSlider({ gestures = [], style = {}, vertical = false, reverse = false, ...props }) {
  ...
  const redGreen = (0, _reactNativeReanimated.useAnimatedStyle)(() => {
