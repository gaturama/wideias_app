...
function TriangleUp({ width, height, thumbColor, adaptiveColor, handleStyle, innerStyle, style, vertical }) {
  const computedStyle = {
    width,
    height,
    ...(vertical
      ? {
          ...
          alignItems: _utils.isRtl ? 'flex-end' : 'flex-start',
        }
      : {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(_reactNativeReanimated.default.View, {
      style: [_styles.styles.triangle, triangleStyle, adaptiveColorStyle, innerStyle],
    }),
  );
}
