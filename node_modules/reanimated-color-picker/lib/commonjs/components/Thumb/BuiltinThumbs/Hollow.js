...
function Hollow({ width, height, borderRadius, thumbColor, adaptiveColor, handleStyle, innerStyle, style }) {
  const computedStyle = {
    width,
    height,
    borderRadius,
  ...
  const adaptiveColorBgStyle = (0, _reactNativeReanimated.useAnimatedStyle)(() => {
    return {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    {
      style: [_styles.styles.handle, style, computedStyle, adaptiveColorStyle, handleStyle],
